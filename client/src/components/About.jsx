...
//           <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M3 3h18v4H3V3zM9 13h6M10 17h4M3 7h18v11H3V7z" />
//         </svg>
//       ),
//       value: "10.5k",
...
//       icon: (
//         <svg xmlns="http://www.w3.org/2000/svg" className="stat-icon" fill="none" viewBox="0 0 24 24" stroke="currentColor">
//           <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M12 8c-1.11 0-2 .89-2 2 0 .74.4 1.37 1 1.73v2.54c-.6.36-1 .99-1 1.73 0 1.11.89 2 2 2s2-.89 2-2c0-.74-.4-1.37-1-1.73v-2.54c.6-.36 1-.99 1-1.73 0-1.11-.89-2-2-2z" />
//         </svg>
//       ),
//       value: "33k",
...
//       icon: (
//         <svg xmlns="http://www.w3.org/2000/svg" className="stat-icon" fill="none" viewBox="0 0 24 24" stroke="currentColor">
//           <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M6 9v12m12-12v12M3 6h18M4 6l2-2h12l2 2" />
//         </svg>
//       ),
//       value: "45.5k",
...
//                   <a key={idx} href={`#${social}`} className={`social-icon ${social}`}>
